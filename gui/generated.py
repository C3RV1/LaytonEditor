...
class FilesystemEditor ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 900,600 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.fp_dcc = wx.Panel( self.fp_formats_book, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		fp_dcc_layout = wx.BoxSizer( wx.VERTICAL )

		self.dcc_editor = wx.stc.StyledTextCtrl( self.fp_dcc, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, 0)
		self.dcc_editor.SetUseTabs ( False )
		self.dcc_editor.SetTabWidth ( 4 )
		self.dcc_editor.SetIndent ( 4 )
		self.dcc_editor.SetTabIndents( True )
		self.dcc_editor.SetBackSpaceUnIndents( True )
		self.dcc_editor.SetViewEOL( False )
		self.dcc_editor.SetViewWhiteSpace( False )
		self.dcc_editor.SetMarginWidth( 2, 0 )
		self.dcc_editor.SetIndentationGuides( True )
		self.dcc_editor.SetReadOnly( False )
		self.dcc_editor.SetMarginType ( 1, wx.stc.STC_MARGIN_SYMBOL )
		self.dcc_editor.SetMarginMask ( 1, wx.stc.STC_MASK_FOLDERS )
		self.dcc_editor.SetMarginWidth ( 1, 16)
		self.dcc_editor.SetMarginSensitive( 1, True )
		self.dcc_editor.SetProperty ( "fold", "1" )
		self.dcc_editor.SetFoldFlags ( wx.stc.STC_FOLDFLAG_LINEBEFORE_CONTRACTED | wx.stc.STC_FOLDFLAG_LINEAFTER_CONTRACTED )
		self.dcc_editor.SetMarginType( 0, wx.stc.STC_MARGIN_NUMBER )
		self.dcc_editor.SetMarginWidth( 0, self.dcc_editor.TextWidth( wx.stc.STC_STYLE_LINENUMBER, "_99999" ) )
		self.dcc_editor.MarkerDefine( wx.stc.STC_MARKNUM_FOLDER, wx.stc.STC_MARK_BOXPLUS )
		self.dcc_editor.MarkerSetBackground( wx.stc.STC_MARKNUM_FOLDER, wx.BLACK)
		self.dcc_editor.MarkerSetForeground( wx.stc.STC_MARKNUM_FOLDER, wx.WHITE)
		self.dcc_editor.MarkerDefine( wx.stc.STC_MARKNUM_FOLDEROPEN, wx.stc.STC_MARK_BOXMINUS )
		self.dcc_editor.MarkerSetBackground( wx.stc.STC_MARKNUM_FOLDEROPEN, wx.BLACK )
		self.dcc_editor.MarkerSetForeground( wx.stc.STC_MARKNUM_FOLDEROPEN, wx.WHITE )
		self.dcc_editor.MarkerDefine( wx.stc.STC_MARKNUM_FOLDERSUB, wx.stc.STC_MARK_EMPTY )
		self.dcc_editor.MarkerDefine( wx.stc.STC_MARKNUM_FOLDEREND, wx.stc.STC_MARK_BOXPLUS )
		self.dcc_editor.MarkerSetBackground( wx.stc.STC_MARKNUM_FOLDEREND, wx.BLACK )
		self.dcc_editor.MarkerSetForeground( wx.stc.STC_MARKNUM_FOLDEREND, wx.WHITE )
		self.dcc_editor.MarkerDefine( wx.stc.STC_MARKNUM_FOLDEROPENMID, wx.stc.STC_MARK_BOXMINUS )
		self.dcc_editor.MarkerSetBackground( wx.stc.STC_MARKNUM_FOLDEROPENMID, wx.BLACK)
		self.dcc_editor.MarkerSetForeground( wx.stc.STC_MARKNUM_FOLDEROPENMID, wx.WHITE)
		self.dcc_editor.MarkerDefine( wx.stc.STC_MARKNUM_FOLDERMIDTAIL, wx.stc.STC_MARK_EMPTY )
		self.dcc_editor.MarkerDefine( wx.stc.STC_MARKNUM_FOLDERTAIL, wx.stc.STC_MARK_EMPTY )
		self.dcc_editor.SetSelBackground( True, wx.SystemSettings.GetColour(wx.SYS_COLOUR_HIGHLIGHT ) )
		self.dcc_editor.SetSelForeground( True, wx.SystemSettings.GetColour(wx.SYS_COLOUR_HIGHLIGHTTEXT ) )
		fp_dcc_layout.Add( self.dcc_editor, 1, wx.EXPAND |wx.ALL, 0 )


		self.fp_dcc.SetSizer( fp_dcc_layout )
		self.fp_dcc.Layout()
		fp_dcc_layout.Fit( self.fp_dcc )
		self.fp_formats_book.AddPage( self.fp_dcc, u"a page", False )
