...
class PuzzleDCC:
    ...
    def parse(self, data: str, include_properties=True):
        self.parser.reset()
        try:
        ...
        if include_properties:
            ...
            self.pz.has_answer_bg = self.parser["pzd.has_answer_bg"]
    ...
    def serialize(self, include_properties=True):
        self.parser.reset()
        if include_properties:
            ...
            self.parser.set_named("pzd.has_answer_bg", self.pz.has_answer_bg)
